...
{
    public partial class FrmRealTrendConfig : Form
    {
        public FrmRealTrendConfig()
        {
            InitializeComponent();
            Load += FrmRealTrendConfig_Load;
        }

        private void FrmRealTrendConfig_Load(object sender, EventArgs e)
        {
        ...
        private void Btn_SetTrend_Click(object sender, EventArgs e)
        {
            ...
            if (inihelper.WriteIniData("已选实时曲线", "selectRealTrend", str, CommonMethods.FilePath))
            {
